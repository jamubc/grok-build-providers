...
const ENV_FILE = path.join(CLIPROXY_AUTH_DIR, 'grok-' + "openrouter" + '.env');
...
if (!process.env["OPENROUTER_API_KEY"]) {
  process.stderr.write('missing ' + "OPENROUTER_API_KEY" + '. Write it to ~/.cli-proxy-api/grok-' + "openrouter" + '.env as ' + "OPENROUTER_API_KEY" + '=<key>\n');
  process.exit(1);
}
...
// Exec grok -m openrouter <args>
const args = ['-m', "openrouter", ...process.argv.slice(2)];
